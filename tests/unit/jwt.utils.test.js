...
(0, vitest_1.describe)('generarAccessToken', () => {
    ...
    (0, vitest_1.it)('dos tokens generados en el mismo ms tienen el mismo payload pero pueden diferir', () => {
...
(0, vitest_1.describe)('verificarAccessToken', () => {
    (0, vitest_1.it)('lanza JsonWebTokenError con un string que no es JWT', () => {
        (0, vitest_1.expect)(() => (0, jwt_utils_1.verificarAccessToken)('esto.no.es.un.jwt')).toThrow(jsonwebtoken_1.JsonWebTokenError);
    });
    (0, vitest_1.it)('lanza JsonWebTokenError con firma de un secreto diferente', () => {
        ...
        (0, vitest_1.expect)(() => (0, jwt_utils_1.verificarAccessToken)(tokenFalso)).toThrow(jsonwebtoken_1.JsonWebTokenError);
    });
    (0, vitest_1.it)('lanza TokenExpiredError con un token ya expirado', () => {
        const tokenExpirado = jsonwebtoken_1.default.sign(PAYLOAD, process.env['JWT_SECRET'], { expiresIn: 0 });
        (0, vitest_1.expect)(() => (0, jwt_utils_1.verificarAccessToken)(tokenExpirado)).toThrow(jsonwebtoken_1.TokenExpiredError);
    });
});
(0, vitest_1.describe)('generarRefreshToken + verificarRefreshToken', () => {
    ...
    (0, vitest_1.it)('el refresh token NO puede verificarse con el access secret', () => {
        ...
        (0, vitest_1.expect)(() => (0, jwt_utils_1.verificarAccessToken)(refresh)).toThrow(jsonwebtoken_1.JsonWebTokenError);
    });
    (0, vitest_1.it)('el access token NO puede verificarse con el refresh secret', () => {
        ...
        (0, vitest_1.expect)(() => (0, jwt_utils_1.verificarRefreshToken)(access)).toThrow(jsonwebtoken_1.JsonWebTokenError);
    });
});
