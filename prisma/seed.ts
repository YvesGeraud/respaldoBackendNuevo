...
async function main() {
  ...
  const platillosData = [
    { nombre: 'Nachos con Queso', desc: 'Crujientes nachos', precio: 85.0, cat: 0 },
    { nombre: 'Alitas BBQ', desc: '10 alitas BBQ', precio: 120.0, cat: 0 },
    { nombre: 'Hamburguesa Clásica', desc: 'Carne de res, queso', precio: 150.0, cat: 1 },
    { nombre: 'Pasta Alfredo', desc: 'Fettuccine en salsa', precio: 165.0, cat: 1 },
    { nombre: 'Pastel de Chocolate', desc: 'Delicioso pastel', precio: 85.0, cat: 2 },
    { nombre: 'Brownie con Helado', desc: 'Con helado', precio: 75.0, cat: 2 },
    { nombre: 'Limonada Natural', desc: 'Recién exprimida', precio: 35.0, cat: 3 },
  ];
